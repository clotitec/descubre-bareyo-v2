...
const POI_I18N = {
    ...
    'playa-ajo': {
        ...
        fr: { name: 'Plage de la Antuerta', desc: 'Une crique cach\u00e9e \u00e0 c\u00f4t\u00e9 de Cuberris : environ 150 m de sable entre les falaises, accessible par un sentier et des escaliers. Sans services et avec de forts courants, elle conserve une ambiance tranquille tr\u00e8s pris\u00e9e des surfeurs et des naturistes.' }
    },
    'playa-cuberris': {
    ...
    'cabo-quintres': {
        ...
        fr: { name: 'Cap de Quintres', desc: "L'une des plus hautes falaises de la côte cantabrique : la pointe de Quintres s'élève à 138 m presque à la verticale au-dessus de la mer. Belvédère naturel dont le panorama, par temps clair, s'étend des Picos de Europa à l'ouest jusqu'à la côte biscaïenne à l'est." }
    },
    'molino-venera': {
        ...
        fr: { name: 'Moulin de La Venera', desc: "Moulin mixte, à marée et à rivière, construit en 1753 sur la ría de Ajo ; l'un des rares moulins de ce type conservés en Cantabrie. Il exploitait à la fois le courant de la rivière et le va-et-vient de la marée pour actionner ses meules. Classé Bien d'Intérêt Culturel." }
    }
};
